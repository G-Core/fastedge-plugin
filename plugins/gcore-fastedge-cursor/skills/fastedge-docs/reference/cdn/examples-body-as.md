...
### FILE: examples/body/assembly/index.ts
...
### FILE: examples/body/package.json

```json
{
  "name": "fastedge-as-example-body",
  "version": "1.0.0",
  "description": "FastEdge AssemblyScript example: Body manipulation",
  "scripts": {
...
Upload `build/body.wasm` to the FastEdge portal and attach it to your CDN application.
```
