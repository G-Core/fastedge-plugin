...
### FILE: examples/cdn/variables_and_secrets/src/lib.rs
...
### FILE: examples/cdn/variables_and_secrets/Cargo.toml
...
### FILE: examples/cdn/variables_and_secrets/README.md

```
[← Back to examples](../../README.md)

# Variables and Secrets (CDN)

Reads `USERNAME` from environment variables and `PASSWORD` from secrets for request forwarding using the proxy-wasm ABI.
```
