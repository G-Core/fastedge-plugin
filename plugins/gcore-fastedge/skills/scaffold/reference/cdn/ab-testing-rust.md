...
### FILE: examples/cdn/ab_testing/src/lib.rs
...
### FILE: examples/cdn/ab_testing/Cargo.toml
...
### FILE: examples/cdn/ab_testing/README.md
...
Cookie-based A/B traffic splitting at the CDN layer, routing requests to different origin paths based on variant assignment.
```
