...
### FILE: examples/cdn/cors/src/lib.rs
...
### FILE: examples/cdn/cors/Cargo.toml
...
### FILE: examples/cdn/cors/README.md
...
Handles Cross-Origin Resource Sharing: preflight OPTIONS responses and CORS headers on all responses for allowed origins.
```
