...
### FILE: examples/mcp-server/src/index.ts
...
### FILE: examples/mcp-server/src/server.ts
...
### FILE: examples/mcp-server/package.json

```json
{
  "name": "fastedge-example-mcp-server",
  "version": "1.0.0",
  "description": "Basic Example of running MCP Server on FastEdge",
  "main": "src/index.ts",
  "type": "module",
  "bin": {
...
### FILE: examples/mcp-server/tsconfig.json
